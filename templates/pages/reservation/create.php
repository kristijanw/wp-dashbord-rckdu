...
<div class="container p-5 reservation-edit">
    ...
    <input type="hidden" id="reservationUpdateOrCreate" name="reservationUpdateOrCreate" value="create">
    ...
    <div class="d-flex mt-5">
        <p class="fs-1">Nova rezervacija</p>
    </div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-4">
            <div>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="user_lastname" value="">
                </div>
            </div>
        </div>
        <div class="col-4">
    ...
    <div class="row mt-5">
        ...
        <div class="col-2">
            <div>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="number_people" value="">
                </div>
            </div>
        </div>
        <div class="col-8">
        ...
        <div class="col-2 w-25">
            <div>
                ...
                <div class="d-flex align-items-center gap-5">
                    <div class="form-group">
                        <input type="time" class="form-control" id="time_reservation_from" value="">
                    </div>
                    <span>-</span>
                    <div class="form-group">
                        <input type="time" class="form-control" id="time_reservation_to" value="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea name="intern_note" class="form-control" id="intern_note" cols="30" rows="10"></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="col-2">
            <div>
                ...
                <select class="form-select" name="status_reservation" id="status_reservation">
                    <option value="Rezervirano">
                        Rezervirano
                    </option>
                    <option value="Gost došao">
                        Gost došao
                    </option>
                    <option value="Gost nije došao">
                        Gost nije došao
                    </option>
                </select>
            </div>
...
<?php function add_pro_reservationcreate_script_to_footer() { ?>
    <script>
...
<?php }
add_action('wp_footer', 'add_pro_reservationcreate_script_to_footer', 999);
?>